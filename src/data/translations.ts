export const translations = {
  en: {
    ...
    myListPage: {
      ...
      duplicateTestError: "This test already exists in your list.",
      ...
      deleteAllTestsConfirm:
        "Are you sure you want to delete all tests from your list?",
      deleteAllTestsError: "Could not delete all tests. Please try again.",
      ...
      editPrintHeaderPage: {
        ...
        saveButton: "Save",
        savingButton: "Saving...",
        saveError: "Could not save header details. Please try again.",
        cancelButton: "Cancel",
      ...
      editTestPage: {
        title: "Edit test",
        description: "Edit the test details.",
        saveButton: "Save",
        savingButton: "Saving...",
        ...
        confirmCancel:
          "Are you sure you want to cancel? All changes will be lost.",
        nameLabel: "Test name",
        namePlaceholder: "Enter test name",
      },
  ...
  ro: {
    ...
    myListPage: {
      ...
      duplicateTestError: "Aceasta analiza exista deja in lista ta.",
      ...
      deleteAllTestsError:
        "Nu s-au putut șterge toate analizele. Încearcă din nou.",
      ...
      editPrintHeaderPage: {
        ...
        saveError: "Nu s-au putut salva datele din antet. Încearcă din nou.",
        ...
        confirmCancel:
          "Sigur vrei să anulezi? Toate modificările vor fi pierdute.",
      },
      editTestPage: {
        title: "Editează analiza",
        description: "Editează detaliile analizei.",
        saveButton: "Salvează",
        savingButton: "Se salvează...",
        ...
        confirmCancel:
          "Sigur vrei să anulezi? Toate modificările vor fi pierdute.",
        nameLabel: "Nume analiză",
        namePlaceholder: "Introduceți numele analizei",
      },
      // Print preview page
      printPreviewPage: {
